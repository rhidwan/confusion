                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            ...
                            <a role="button" className="btn btn-info" href="skype:iqbalrhidwan52"><i className="fa fa-skype"></i> Skype</a>
                    ...
                    <div className="col-12 col-sm-6 offset-sm-1">
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" name="telnum" id="telnum" placeholder="Tel num"  className="form-control"
                                     validators={{
                                         required,
                                         minLength: minLength(3),
                                         maxLength: maxLength(15),
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".email" name="email" id="email" placeholder="example@abc.com"  className="form-control"
                                     validators={{
                                         required,
                                        validEmail
                                     }} />
